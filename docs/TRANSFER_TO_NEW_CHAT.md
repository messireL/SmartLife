...
- v0.5.2 — исправление миграции БД: добавлен столбец `devices.notes`, из-за отсутствия которого на существующей PostgreSQL базе страницы могли падать с Internal Server Error после релиза v0.5.x.
